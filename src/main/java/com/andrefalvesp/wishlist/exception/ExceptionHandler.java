...
public class ExceptionHandler extends DefaultHandlerExceptionResolver {
  ...
  @org.springframework.web.bind.annotation.ExceptionHandler({MaxItemsExceededException.class})
  @ResponseStatus(HttpStatus.BAD_REQUEST)
  public ExceptionResponse handleMaxItemsException(
      final MaxItemsExceededException ex,
  ...
  @ResponseStatus(HttpStatus.BAD_REQUEST)
  public ExceptionResponse handleDuplicateItemException(
      final DuplicateItemException ex,
      final HttpServletRequest request) {
    log.warn(ex.getMessage(), ex);
    return new ExceptionResponse(ex.getMessage(), HttpStatus.BAD_REQUEST, request.getRequestURI());
  }

  @org.springframework.web.bind.annotation.ExceptionHandler({DeleteItemNotFoundException.class})
  @ResponseStatus(HttpStatus.NOT_FOUND)
  public ExceptionResponse handleDeleteItemNotFoundException(
      final DeleteItemNotFoundException ex,
      final HttpServletRequest request) {
    log.warn(ex.getMessage(), ex);
    return new ExceptionResponse(ex.getMessage(), HttpStatus.NOT_FOUND, request.getRequestURI());
  }
